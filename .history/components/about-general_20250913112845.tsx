              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-white group-hover:shadow-3xl transition-all duration-500">
                ...
                <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-bold text-gray-700">Hệ sinh thái đối tác</span>
                  </div>
                </div>
                <div className="absolute bottom-6 right-6 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 rounded-full shadow-xl">
                  <div className="text-center">
                    <div className="text-2xl font-bold">15+</div>
                    <div className="text-xs">Năm phát triển</div>
                  </div>
                </div>
              </div>
            </div>
