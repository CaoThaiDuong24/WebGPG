                  ...
                  <div className="text-center text-white max-w-5xl mx-auto">
                    ...
                    <div className="bg-white/20 backdrop-blur-md p-8 rounded-2xl border border-white/30">
                      <p className="text-2xl text-white leading-relaxed font-medium drop-shadow-md">
                        Với hệ thống <span className="font-bold text-yellow-300">11 văn phòng</span>, <span className="font-bold text-yellow-300">16 bãi container</span> và đội xe logistics chuyên nghiệp, GPG phục vụ hơn <span className="font-bold text-yellow-300">21 hãng tàu</span> trên toàn quốc.
                      </p>
                    </div>
                  </div>
                </div>
