              ...
              <div className="relative group">
                <div className="relative rounded-3xl overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-500">
                  <Image
                    ...
                    alt="Kho logistics hiện đại với container và xe tải - TCT Đối Tác Chân Thật"
                    width={600}
                    height={700}
                    className="object-cover w-full h-[700px] group-hover:scale-105 transition-transform duration-700"
                  />
                    ...
                    <div className="p-12 w-full">
                      <div className="max-w-2xl">
                        <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-md rounded-full px-6 py-3 mb-6 border border-white/30 shadow-xl">
                          ...
                          <span className="text-white font-semibold">Thành tựu hoạt động</span>
                          <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                        </div>
                        
                        <h3 className="text-4xl font-black text-white mb-6 leading-tight">
                          15 năm <span className="bg-gradient-to-r from-green-300 to-emerald-300 bg-clip-text text-transparent">phát triển vững mạnh</span>
                        </h3>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="bg-white/20 backdrop-blur-md p-4 rounded-xl border border-white/30">
                            ...
                            <div className="text-blue-200 text-sm">Văn phòng</div>
                          </div>
                          <div className="bg-white/20 backdrop-blur-md p-4 rounded-xl border border-white/30">
                            <div className="text-2xl font-bold text-white mb-1">16</div>
                            <div className="text-blue-200 text-sm">Bãi container</div>
                          </div>
                          <div className="bg-white/20 backdrop-blur-md p-4 rounded-xl border border-white/30">
                            <div className="text-2xl font-bold text-white mb-1">21</div>
                            <div className="text-blue-200 text-sm">Hãng tàu</div>
                          </div>
                          <div className="bg-white/20 backdrop-blur-md p-4 rounded-xl border border-white/30">
                            <div className="text-2xl font-bold text-white mb-1">65K</div>
                            <div className="text-blue-200 text-sm">TEUs</div>
                          </div>
                </div>
                    </div>
                    </div>
                  ...
                  <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-white group-hover:shadow-3xl transition-all duration-500">
                    ...
                    <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                        <span className="text-sm font-medium text-gray-700">Hệ sinh thái GPG</span>
                      </div>
                    </div>
                    <div className="absolute bottom-0 left-0 right-0 p-10">
                      <div className="text-center text-white max-w-5xl mx-auto">
                        <h3 className="text-4xl md:text-5xl font-black mb-6 text-white drop-shadow-lg">Hệ sinh thái TCT Đối Tác Chân Thật</h3>
                        <div className="bg-white/20 backdrop-blur-md p-8 rounded-2xl border border-white/30">
                          <p className="text-2xl text-white leading-relaxed font-medium drop-shadow-md">
                            Tích hợp <span className="font-bold text-yellow-300">4 lĩnh vực chính</span>: Logistics & Phụ trợ, Dịch vụ & Thương mại, Tư vấn & Công nghệ, Cộng đồng & An sinh
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="relative mb-20">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-500">
                <Image
                  ...
                  alt="Văn phòng công nghệ hiện đại - Đội ngũ TCT Đối Tác Chân Thật"
                  width={1200}
                  height={600}
                  className="object-cover w-full h-[600px] group-hover:scale-105 transition-transform duration-700"
                />
                  ...
                  <div className="p-12 w-full">
                    <div className="max-w-6xl">
                      <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-md rounded-full px-6 py-3 mb-6 border border-white/30 shadow-xl">
                        ...
                        <span className="text-white font-semibold">Giá trị cốt lõi</span>
                        <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                      </div>
                      
                      <h3 className="text-5xl font-black text-white mb-6 leading-tight">
                        Ba trụ cột <span className="bg-gradient-to-r from-blue-300 to-cyan-300 bg-clip-text text-transparent">vững chắc</span>
                      </h3>
