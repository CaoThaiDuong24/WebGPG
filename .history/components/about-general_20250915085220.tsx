                ...
                <div className="p-16">
                  <div className="text-center mb-12">
                    ...
                    <h3 className="text-5xl font-black text-white mb-6 leading-tight tracking-tight">
                      Ba trụ cột <span className="bg-gradient-to-r from-blue-300 via-cyan-300 to-blue-200 bg-clip-text text-transparent">vững chắc</span>
                    </h3>
                  ...
                  <div className="grid md:grid-cols-3 gap-10">
                    <div className="text-center group">
                      ...
                      <h4 className="text-2xl font-bold text-white mb-6 group-hover:text-blue-300 transition-colors duration-300">AN TOÀN</h4>
                    ...
                    <div className="text-center group">
                      ...
                      <h4 className="text-2xl font-bold text-white mb-6 group-hover:text-green-300 transition-colors duration-300">CHẤT LƯỢNG</h4>
                      <p className="text-blue-100 text-lg leading-relaxed font-medium">
                    ...
                    <div className="text-center group">
                      ...
                      <h4 className="text-2xl font-bold text-white mb-6 group-hover:text-orange-300 transition-colors duration-300">KỊP THỜI</h4>
                      <p className="text-blue-100 text-lg leading-relaxed font-medium">
