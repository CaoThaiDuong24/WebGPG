                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 group-hover:shadow-3xl transition-all duration-500">
                  ...
                  <div className="absolute top-8 left-8 right-8">
                    <div className="bg-white/20 backdrop-blur-md rounded-2xl p-6 border border-white/30 shadow-xl">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          <h3 className="text-3xl font-black text-white">Thành tựu hoạt động</h3>
                          <p className="text-blue-200 text-lg">15 năm phát triển vững mạnh</p>
                        </div>
                      </div>
                      <p className="text-white/90 text-lg leading-relaxed">
                        Hệ thống logistics quy mô lớn với <span className="font-bold text-yellow-300">11 văn phòng</span>, <span className="font-bold text-yellow-300">16 bãi container</span> và đội xe chuyên nghiệp
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-8 left-8 right-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-3 rounded-xl shadow-lg text-center">
                        <div className="text-2xl font-bold">11</div>
                        <div className="text-xs text-blue-200">Văn phòng</div>
                      </div>
                      <div className="bg-gradient-to-r from-green-500 to-green-600 text-white px-4 py-3 rounded-xl shadow-lg text-center">
                        <div className="text-2xl font-bold">16</div>
                        <div className="text-xs text-green-200">Bãi container</div>
                      </div>
                      <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white px-4 py-3 rounded-xl shadow-lg text-center">
                        <div className="text-2xl font-bold">21</div>
                        <div className="text-xs text-purple-200">Hãng tàu</div>
                      </div>
                      <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-4 py-3 rounded-xl shadow-lg text-center">
                        <div className="text-2xl font-bold">65K</div>
                        <div className="text-xs text-orange-200">TEUs</div>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className="py-32 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Ecosystem Services Showcase */}
            <div className="relative mb-20">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 group-hover:shadow-3xl transition-all duration-500">
                <div className="p-16">
                  <div className="text-center mb-12">
                    <h3 className="text-4xl font-black text-gray-900 mb-4">Hệ sinh thái dịch vụ</h3>
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                      TCT ĐTCT cung cấp giải pháp logistics toàn diện với 4 nhóm dịch vụ chính
                    </p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="text-center group">
                      ...
                      <h4 className="text-xl font-bold text-gray-900 mb-3">Logistics & Phụ trợ</h4>
                      <p className="text-gray-600 leading-relaxed">
                        Dịch vụ logistics chuyên nghiệp, depot container và vận chuyển đa phương thức
                      </p>
                    </div>
                    ...
                    <div className="text-center group">
                      ...
                      <h4 className="text-xl font-bold text-gray-900 mb-3">Dịch vụ & Thương mại</h4>
                      <p className="text-gray-600 leading-relaxed">
                        Các hoạt động mở rộng đáp ứng nhu cầu sinh hoạt của thành viên
                      </p>
                    </div>
                    ...
                    <div className="text-center group">
                      ...
                      <h4 className="text-xl font-bold text-gray-900 mb-3">Tư vấn & Công nghệ</h4>
                      <p className="text-gray-600 leading-relaxed">
                        Phát triển chiến lược kinh doanh, marketing và tư vấn công nghệ
                      </p>
                    </div>
                    ...
                    <div className="text-center group">
                      ...
                      <h4 className="text-xl font-bold text-gray-900 mb-3">Cộng đồng & An sinh</h4>
                      <p className="text-gray-600 leading-relaxed">
                        Thúc đẩy hoạt động cộng đồng và phúc lợi xã hội bền vững
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {/* Company Statistics Image - Main Focus */}
            <div className="relative group">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 group-hover:shadow-3xl transition-all duration-500">
                <Image
                  src="/company-statistics.svg"
                  ...
                  width={1200}
                  height={500}
                  className="object-contain w-full h-[500px] p-12 group-hover:scale-105 transition-transform duration-700"
                />
                ...
                <div className="absolute top-8 left-8 right-8">
                  <div className="bg-white/20 backdrop-blur-md rounded-2xl p-6 border border-white/30 shadow-xl">
                    ...
                    <p className="text-white/90 text-lg leading-relaxed">
                      Hệ thống logistics quy mô lớn với <span className="font-bold text-yellow-300">11 văn phòng</span>, <span className="font-bold text-yellow-300">16 bãi container</span> và đội xe chuyên nghiệp phục vụ <span className="font-bold text-yellow-300">21 hãng tàu</span>
                    </p>
                  </div>
                </div>
      ...
      <div className="py-32 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            {/* Core Values Image - Main Focus */}
            <div className="relative mb-20">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-slate-800 via-blue-800 to-indigo-800 group-hover:shadow-3xl transition-all duration-500">
                <Image
                  src="/gpg-values-banner.svg"
                  ...
                  className="object-contain w-full h-[500px] p-12 group-hover:scale-105 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-r from-slate-800/70 via-transparent to-slate-800/70"></div>
                ...
                <div className="absolute top-8 left-8 right-8">
                  <div className="bg-white/20 backdrop-blur-md rounded-2xl p-6 border border-white/30 shadow-xl">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <h3 className="text-3xl font-black text-white">Giá trị cốt lõi</h3>
                        <p className="text-blue-200 text-lg">5 mục tiêu chiến lược</p>
                      </div>
                    </div>
                    <p className="text-white/90 text-lg leading-relaxed">
                      Từ tăng trưởng doanh số đến tạo giá trị cộng đồng - hành trình phát triển bền vững của TCT ĐTCT
                    </p>
                  </div>
                </div>
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-3 rounded-xl shadow-lg text-center">
                      <div className="text-sm font-bold">Tăng trưởng</div>
                      <div className="text-xs text-blue-200">Doanh số</div>
                    </div>
                    <div className="bg-gradient-to-r from-green-500 to-green-600 text-white px-4 py-3 rounded-xl shadow-lg text-center">
                      <div className="text-sm font-bold">Tạo giá trị</div>
                      <div className="text-xs text-green-200">Khách hàng</div>
                    </div>
                    <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white px-4 py-3 rounded-xl shadow-lg text-center">
                      <div className="text-sm font-bold">Hiệu quả</div>
                      <div className="text-xs text-purple-200">Hoạt động</div>
                    </div>
                    <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-4 py-3 rounded-xl shadow-lg text-center">
                      <div className="text-sm font-bold">Thương hiệu</div>
                      <div className="text-xs text-orange-200">Sức mạnh</div>
                    </div>
                    <div className="bg-gradient-to-r from-pink-500 to-pink-600 text-white px-4 py-3 rounded-xl shadow-lg text-center">
                      <div className="text-sm font-bold">Cộng đồng</div>
                      <div className="text-xs text-pink-200">Giá trị</div>
                    </div>
                  </div>
                </div>
              </div>
