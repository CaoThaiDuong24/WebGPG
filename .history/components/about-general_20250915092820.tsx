...
const AboutGeneral = () => {
  return (
    <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 pt-20">
      ...
      <div className="py-40 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
        {/* Professional background elements */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-blue-200/40 to-indigo-200/40 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-gradient-to-tr from-purple-200/30 to-pink-200/30 rounded-full blur-2xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-r from-cyan-200/20 to-blue-200/20 rounded-full blur-3xl"></div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="space-y-8">
                  <div className="inline-flex items-center gap-4 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-full px-8 py-4 border border-blue-300/50 shadow-xl hover:shadow-2xl transition-all duration-500">
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-3 rounded-full shadow-lg">
                      <Building2 className="h-6 w-6 text-white" />
                    </div>
                    <span className="text-blue-800 font-bold text-lg">Về chúng tôi</span>
                    <div className="w-3 h-3 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full animate-pulse shadow-lg"></div>
                  </div>

                  <h2 className="text-6xl md:text-7xl font-black text-gray-900 leading-tight tracking-tight">
                    TCT Đối Tác <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent drop-shadow-lg">Chân Thật</span>
                  </h2>

                  <p className="text-3xl text-gray-700 leading-relaxed font-medium">
                    Doanh nghiệp hàng đầu trong lĩnh vực <span className="font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">logistics</span> tại Việt Nam
                  </p>
                </div>
                
                <div className="bg-gradient-to-r from-blue-100 to-indigo-100 p-10 rounded-3xl border border-blue-200/50 shadow-2xl hover:shadow-3xl transition-all duration-500 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <p className="text-xl text-gray-800 leading-relaxed font-medium">
                      Tổng Công ty Đối Tác Chân Thật (TCT ĐTCT) được thành lập vào ngày <span className="font-bold text-blue-700 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">11/5/2009</span> toạ lạc tại tòa nhà số 2A đường 5, phường An Phú, TP Thủ Đức, TP.HCM. Sau gần <span className="font-bold text-indigo-700 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">15 năm</span> xây dựng và trưởng thành, TCT ĐTCT đã trở thành một trong những doanh nghiệp hàng đầu trong lĩnh vực logistics tại Việt Nam.
                    </p>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-24">
              <div className="inline-flex items-center gap-4 bg-white/95 backdrop-blur-lg rounded-full px-10 py-5 mb-12 border border-white/60 shadow-2xl hover:shadow-3xl transition-all duration-500">
                <div className="bg-gradient-to-r from-indigo-500 to-indigo-600 p-3 rounded-full shadow-lg">
                  <Globe className="h-7 w-7 text-white" />
                </div>
                <span className="text-indigo-800 font-bold text-xl">Hệ sinh thái</span>
                <div className="w-3 h-3 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full animate-pulse shadow-lg"></div>
              </div>
              
              <h2 className="text-6xl md:text-7xl font-black text-gray-900 mb-12 leading-tight tracking-tight">
                Hệ sinh thái <span className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent drop-shadow-lg">TCT Đối tác Chân Thật</span>
              </h2>
              
              <div className="bg-white/90 backdrop-blur-lg p-12 rounded-3xl border border-white/60 shadow-2xl max-w-6xl mx-auto hover:shadow-3xl transition-all duration-500 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 rounded-full blur-xl"></div>
                <div className="relative z-10">
                  <p className="text-2xl text-gray-800 leading-relaxed font-medium">
                    TCT ĐTCT đã xây dựng <span className="font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Hệ sinh thái Đối Tác Chân Thật</span> với logistics là ngành trọng tâm, mục tiêu giải quyết các yêu cầu về phát triển bền vững, số hóa, vận chuyển đa phương thức, tuân thủ quy định, nhân lực tương lai và giảm khí thải.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="py-40 bg-gradient-to-br from-white via-green-50 to-emerald-100 relative overflow-hidden">
        {/* Professional background elements */}
        <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-gradient-to-br from-green-200/40 to-emerald-200/40 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-gradient-to-tr from-blue-200/30 to-cyan-200/30 rounded-full blur-2xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-r from-teal-200/20 to-green-200/20 rounded-full blur-3xl"></div>
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-24">
              <div className="inline-flex items-center gap-4 bg-gradient-to-r from-green-100 to-emerald-100 rounded-full px-10 py-5 mb-12 border border-green-300/50 shadow-2xl hover:shadow-3xl transition-all duration-500">
                <div className="bg-gradient-to-r from-green-500 to-green-600 p-3 rounded-full shadow-lg">
                  <Award className="h-7 w-7 text-white" />
                </div>
                <span className="text-green-800 font-bold text-xl">Phát triển bền vững</span>
                <div className="w-3 h-3 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full animate-pulse shadow-lg"></div>
              </div>
              
              <h2 className="text-6xl md:text-7xl font-black text-gray-900 leading-tight tracking-tight mb-12">
                Mục tiêu <span className="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 bg-clip-text text-transparent drop-shadow-lg">Phát triển bền vững</span>
              </h2>
      ...
      {/* Values Section */}
      <div className="py-40 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden">
        {/* Professional background elements */}
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-gradient-to-br from-blue-500/30 to-indigo-500/30 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-gradient-to-tr from-purple-500/30 to-pink-500/30 rounded-full blur-3xl animate-pulse delay-1000"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-full blur-3xl"></div>
        </div>
        
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            <div className="mb-24">
              <div className="inline-flex items-center gap-4 bg-white/25 backdrop-blur-lg rounded-full px-10 py-5 mb-12 border border-white/40 shadow-2xl hover:shadow-3xl transition-all duration-500">
                <div className="bg-gradient-to-r from-blue-400 to-blue-500 p-3 rounded-full shadow-lg">
                  <Diamond className="h-7 w-7 text-white" />
                </div>
                <span className="text-blue-200 font-bold text-xl">Giá trị cốt lõi</span>
                <div className="w-3 h-3 bg-gradient-to-r from-green-400 to-emerald-400 rounded-full animate-pulse shadow-lg"></div>
              </div>
              
              <h2 className="text-6xl md:text-7xl font-black text-white mb-12 leading-tight tracking-tight">
                Giá trị <span className="bg-gradient-to-r from-blue-300 via-cyan-300 to-blue-200 bg-clip-text text-transparent drop-shadow-2xl">cốt lõi</span>
              </h2>
              
              <div className="bg-white/25 backdrop-blur-lg p-12 rounded-3xl border border-white/40 shadow-2xl max-w-5xl mx-auto hover:shadow-3xl transition-all duration-500 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <p className="text-3xl text-blue-100 leading-relaxed font-medium">
