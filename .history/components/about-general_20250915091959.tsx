    ...
    <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 pt-20">
      ...
      <div className="relative overflow-hidden min-h-screen flex items-center">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-20 left-10 w-20 h-20 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-full blur-xl animate-pulse"></div>
          <div className="absolute top-40 right-20 w-32 h-32 bg-gradient-to-br from-indigo-500/15 to-purple-500/15 rounded-full blur-2xl animate-pulse delay-1000"></div>
          <div className="absolute bottom-20 left-1/4 w-24 h-24 bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-full blur-xl animate-pulse delay-2000"></div>
          <div className="absolute top-1/2 right-1/4 w-16 h-16 bg-gradient-to-br from-amber-500/25 to-orange-500/25 rounded-full blur-lg animate-pulse delay-500"></div>
          <div className="absolute bottom-1/3 right-1/3 w-12 h-12 bg-gradient-to-br from-rose-500/20 to-pink-500/20 rounded-full blur-md animate-pulse delay-1500"></div>
        </div>
        ...
        <div className="relative z-10 w-full">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto text-center">
              ...
              <div className="inline-flex items-center gap-4 bg-white/25 backdrop-blur-lg rounded-full px-10 py-5 mb-16 border border-white/40 shadow-2xl hover:bg-white/30 transition-all duration-500">
                <div className="bg-gradient-to-r from-blue-500 to-cyan-500 p-3 rounded-full shadow-lg">
                  <Building2 className="h-7 w-7 text-white" />
                </div>
                <span className="text-white font-bold text-xl tracking-wide">TCT Đối Tác Chân Thật</span>
              ...
              <h1 className="text-7xl md:text-9xl font-black mb-10 text-white leading-tight tracking-tight">
                <span className="bg-gradient-to-r from-white via-cyan-100 to-blue-200 bg-clip-text text-transparent drop-shadow-2xl">
                  Giới thiệu chung
                </span>
              </h1>
              
              {/* Professional Subtitle */}
              <p className="text-3xl md:text-4xl mb-20 text-blue-50 leading-relaxed max-w-6xl mx-auto font-light">
                Từ <span className="text-white font-bold bg-gradient-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent">tòa nhà văn phòng hiện đại</span> đến <span className="text-white font-bold bg-gradient-to-r from-emerald-300 to-teal-300 bg-clip-text text-transparent">hệ thống logistics quy mô lớn</span>
                <br />
                <span className="text-2xl md:text-3xl text-blue-200 font-medium">15 năm phát triển bền vững và chuyên nghiệp</span>
              </p>
              
              {/* Professional Statistics Cards */}
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl mx-auto">
                <div className="group bg-white/20 backdrop-blur-lg rounded-3xl px-8 py-8 border border-white/30 shadow-2xl hover:bg-white/25 transition-all duration-500 hover:scale-110 hover:-translate-y-3 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-blue-100 text-lg font-semibold mb-4">Năm kinh nghiệm</div>
                    <div className="w-full h-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full group-hover:w-full transition-all duration-500"></div>
                  </div>
                </div>
                ...
                <div className="group bg-white/20 backdrop-blur-lg rounded-3xl px-8 py-8 border border-white/30 shadow-2xl hover:bg-white/25 transition-all duration-500 hover:scale-110 hover:-translate-y-3 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="text-5xl font-black text-white mb-3 group-hover:scale-110 transition-transform duration-300">11</div>
                    <div className="text-blue-100 text-lg font-semibold mb-4">Văn phòng</div>
                    <div className="w-full h-2 bg-gradient-to-r from-emerald-400 to-green-400 rounded-full group-hover:w-full transition-all duration-500"></div>
                  </div>
                </div>
                
                <div className="group bg-white/20 backdrop-blur-lg rounded-3xl px-8 py-8 border border-white/30 shadow-2xl hover:bg-white/25 transition-all duration-500 hover:scale-110 hover:-translate-y-3 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-purple-500/20 to-indigo-500/20 rounded-full blur-xl"></div>
                  <div className="relative z-10">
                    <div className="text-5xl font-black text-white mb-3 group-hover:scale-110 transition-transform duration-300">16</div>
                    <div className="text-blue-100 text-lg font-semibold mb-4">Bãi container</div>
                    <div className="w-full h-2 bg-gradient-to-r from-purple-400 to-indigo-400 rounded-full group-hover:w-full transition-all duration-500"></div>
                  </div>
                </div>
                
                <div className="group bg-white/20 backdrop-blur-lg rounded-3xl px-8 py-8 border border-white/30 shadow-2xl hover:bg-white/25 transition-all duration-500 hover:scale-110 hover:-translate-y-3 relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-amber-500/20 to-orange-500/20 rounded-full blur-xl"></div>
                  <div className="relative z-10">
                    <div className="text-5xl font-black text-white mb-3 group-hover:scale-110 transition-transform duration-300">21</div>
                    <div className="text-blue-100 text-lg font-semibold mb-4">Hãng tàu</div>
                    <div className="w-full h-2 bg-gradient-to-r from-amber-400 to-orange-400 rounded-full group-hover:w-full transition-all duration-500"></div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-20">
                <button className="group inline-flex items-center gap-4 bg-gradient-to-r from-blue-600 via-cyan-600 to-indigo-600 hover:from-blue-700 hover:via-cyan-700 hover:to-indigo-700 text-white font-bold text-lg px-12 py-6 rounded-full shadow-2xl hover:shadow-blue-500/30 transition-all duration-500 hover:scale-110 hover:-translate-y-2 border border-white/20">
