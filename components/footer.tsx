          ...
          <div className="sm:col-span-2 lg:col-span-1 space-y-6 sm:space-y-8">
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="relative">
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 via-indigo-600 to-violet-500 rounded-2xl flex items-center justify-center shadow-2xl animate-pulse">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-blue-400 via-indigo-500 to-violet-500 bg-clip-text text-transparent">
                  Genuine Partner
                </h3>
                <p className="text-gray-300 text-xs sm:text-sm font-medium">Group</p>
              </div>
            </div>
