...
const timelineEvents: TimelineEvent[] = [
  {
    year: "2009",
    title: "Thành lập Tổng Công Ty Đối Tác Chân Thật",
          ...
          <div className={`text-center transition-all duration-1500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
            ...
            <div className="max-w-5xl mx-auto">
              <p className="text-2xl md:text-3xl text-gray-700 leading-relaxed mb-6 font-light">
                Sau gần <span className="font-bold text-blue-600">15 năm</span> xây dựng và trưởng thành
              </p>
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed font-light">
                TCT ĐTCT đã trở thành một trong những <span className="font-semibold text-indigo-600">doanh nghiệp hàng đầu</span> trong lĩnh vực logistics tại Việt Nam
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-6xl mx-auto">
            ...
            <div className="max-w-5xl mx-auto mb-16">
              <p className="text-2xl md:text-3xl text-gray-700 leading-relaxed mb-6 font-light">
                Từ một <span className="font-bold text-blue-600">công ty khởi nghiệp</span> năm 2009
              </p>
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed font-light">
                Chúng tôi đã phát triển thành một <span className="font-semibold text-indigo-600">hệ sinh thái đa dạng</span> với 22 công ty thành viên, 15 depot container trong nước và quốc tế, và là đối tác đáng tin cậy của nhiều tập đoàn lớn trong và ngoài nước.
              </p>
            </div>
