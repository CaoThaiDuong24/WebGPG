...
import { Building2, Users, Globe, Target, Leaf, Award, TrendingUp, Diamond, Users2 } from 'lucide-react';
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            fill
            className="object-contain bg-gradient-to-r from-blue-50 to-indigo-100"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-r from-blue-900/70 via-indigo-800/60 to-blue-700/70"></div>
        </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 mb-8">
                ...
                <span className="text-blue-100 font-medium">TCT Đối Tác Chân Thật</span>
              </div>
              <h1 className="text-5xl md:text-7xl font-bold mb-8 text-white leading-tight">
                Giới thiệu chung
              </h1>
              <p className="text-xl md:text-2xl mb-12 text-blue-100 leading-relaxed max-w-4xl mx-auto">
                Chúng tôi coi trọng việc chăm sóc Khách hàng và Đối tác ngang bằng với sự thành công trong kinh doanh
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg px-6 py-4">
                  <div className="text-3xl font-bold text-white">65K</div>
                  <div className="text-blue-200 text-sm">TEUs sức chứa</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg px-6 py-4">
                  <div className="text-3xl font-bold text-white">633K</div>
                  <div className="text-blue-200 text-sm">m² diện tích</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  <div className="inline-flex items-center gap-2 bg-blue-50 rounded-full px-4 py-2">
                    ...
                    <span className="text-blue-700 font-medium text-sm">Về chúng tôi</span>
                  </div>
                  <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                    TCT Đối Tác <span className="text-blue-600">Chân Thật</span>
                  </h2>
                  <p className="text-xl text-gray-600 leading-relaxed">
                    Doanh nghiệp hàng đầu trong lĩnh vực logistics tại Việt Nam
                  </p>
                </div>
                
                <p className="text-lg text-gray-700 leading-relaxed">
                  Tổng Công ty Đối Tác Chân Thật (TCT ĐTCT) được thành lập vào ngày 11/5/2009 toạ lạc tại tòa nhà số 2A đường 5, phường An Phú, TP Thủ Đức, TP.HCM. Sau gần 15 năm xây dựng và trưởng thành, TCT ĐTCT đã trở thành một trong những doanh nghiệp hàng đầu trong lĩnh vực logistics tại Việt Nam.
                </p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-2xl border border-blue-200">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-lg font-semibold text-blue-900">Quy mô hoạt động</h3>
                    </div>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-center gap-2">
                        <div className="w-1.5 h-1.5 bg-blue-600 rounded-full"></div>
                        15 Depots với sức chứa 65.000 TEUs
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-1.5 h-1.5 bg-blue-600 rounded-full"></div>
                        Tổng diện tích hơn 633.000 m²
                      </li>
                      <li className="flex items-center gap-2">
                        <div className="w-1.5 h-1.5 bg-blue-600 rounded-full"></div>
                        Hoạt động tại Việt Nam, Campuchia, Thái Lan
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-2xl border border-green-200">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-lg font-semibold text-green-900">Dịch vụ chính</h3>
                    </div>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-center gap-2">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-8 rounded-2xl text-white">
                  <h3 className="text-xl font-semibold mb-4">Phương châm hoạt động</h3>
                  <p className="text-lg leading-relaxed">
                    <strong>"An toàn – Chất lượng – Phục vụ kịp thời và nhanh chóng"</strong>
                  </p>
              ...
              <div className="relative">
                <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-white">
                  <Image
                    ...
                    width={600}
                    height={700}
                    className="object-contain w-full h-[700px] p-8"
                  />
