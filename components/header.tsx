          ...
          <nav className="hidden lg:flex items-center space-x-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-64 z-[60] bg-white/95 backdrop-blur-xl shadow-2xl border border-blue-100/50 rounded-2xl p-2">
                <DropdownMenuItem className={`py-3 px-4 rounded-xl transition-all duration-300 ${
                  isActive('/gioi-thieu-chung') 
                    ? 'bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-600' 
                    : 'hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50'
                }`}>
                  <a href="/gioi-thieu-chung" className="w-full flex items-center space-x-3">
                ...
                <DropdownMenuItem className={`py-3 px-4 rounded-xl transition-all duration-300 ${
                  ...
                  <a href="/tam-nhin-su-menh" className="w-full flex items-center space-x-3">
                    <div className={`w-2 h-2 rounded-full ${
                      isActive('/tam-nhin-su-menh') 
                        ? 'bg-blue-600' 
                        : 'bg-gradient-to-r from-blue-500 to-indigo-500'
                ...
                <DropdownMenuItem className={`py-3 px-4 rounded-xl transition-all duration-300 ${
                  ...
                  <a href="/lich-su-hinh-thanh" className="w-full flex items-center space-x-3">
                    <div className={`w-2 h-2 rounded-full ${
                      isActive('/lich-su-hinh-thanh') 
                        ? 'bg-blue-600' 
                        : 'bg-gradient-to-r from-blue-500 to-indigo-500'
                ...
                <DropdownMenuItem className={`py-3 px-4 rounded-xl transition-all duration-300 ${
                  ...
                  <a href="/thanh-tuu-cua-chung-toi" className="w-full flex items-center space-x-3">
                    <div className={`w-2 h-2 rounded-full ${
                      isActive('/thanh-tuu-cua-chung-toi') 
                        ? 'bg-blue-600' 
                        : 'bg-gradient-to-r from-blue-500 to-indigo-500'
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className={`relative group flex items-center space-x-1 transition-all duration-300 font-medium px-4 py-2.5 rounded-xl ${
                  ...
                  <span className="relative z-10">Hệ sinh thái</span>
                  <ChevronDown className="w-4 h-4 relative z-10 transition-transform duration-300 group-hover:rotate-180" />
                  {!(isActive('/nhom-than') || isActive('/nhom-tam') || isActive('/nhom-tri') || isActive('/nhom-thien')) && (
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  )}
              ...
              <DropdownMenuContent className="w-72 z-[60] bg-white/95 backdrop-blur-xl shadow-2xl border border-blue-100/50 rounded-2xl p-2">
                <DropdownMenuItem className={`py-4 px-4 rounded-xl transition-all duration-300 ${
                  isActive('/nhom-than') 
                    ? 'bg-gradient-to-r from-blue-50 to-indigo-50' 
                    : 'hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50'
                }`}>
                  <a href="/nhom-than" className="w-full">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className={`font-medium ${isActive('/nhom-than') ? 'text-blue-600' : 'text-gray-900'}`}>Thân - Logistics & Phụ trợ</div>
                ...
                <DropdownMenuItem className={`py-4 px-4 rounded-xl transition-all duration-300 ${
                  ...
                  <a href="/nhom-tam" className="w-full">
                    <div className="flex items-center space-x-3">
                      <div className={`w-3 h-3 rounded-full ${
                        isActive('/nhom-tam') 
                          ? 'bg-blue-600' 
                      ...
                      <div>
                        <div className={`font-medium ${isActive('/nhom-tam') ? 'text-blue-600' : 'text-gray-900'}`}>Tâm - Dịch vụ & Thương mại</div>
                ...
                <DropdownMenuItem className={`py-4 px-4 rounded-xl transition-all duration-300 ${
                  ...
                  <a href="/nhom-tri" className="w-full">
                    <div className="flex items-center space-x-3">
                      <div className={`w-3 h-3 rounded-full ${
                        isActive('/nhom-tri') 
                          ? 'bg-blue-600' 
                      ...
                      <div>
                        <div className={`font-medium ${isActive('/nhom-tri') ? 'text-blue-600' : 'text-gray-900'}`}>Trí - Tư vấn & Công nghệ</div>
                ...
                <DropdownMenuItem className={`py-4 px-4 rounded-xl transition-all duration-300 ${
                  ...
                  <a href="/nhom-thien" className="w-full">
                    <div className="flex items-center space-x-3">
                      <div className={`w-3 h-3 rounded-full ${
                        isActive('/nhom-thien') 
                          ? 'bg-blue-600' 
                      ...
                      <div>
                        <div className={`font-medium ${isActive('/nhom-thien') ? 'text-blue-600' : 'text-gray-900'}`}>Thiện - Cộng đồng</div>
            ...
            >
              <span className="relative z-10">Trách nhiệm xã hội</span>
              ...
              <div className="space-y-2">
                ...
                >
                  <span className="relative z-10 flex items-center space-x-3">
                    ...
                    <span>Thần - Logistics & Phụ trợ</span>
                  </span>
                  {!isActive('/nhom-than') && (
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  )}
